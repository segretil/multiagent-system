...
public class ConwaySimulatorEvent implements Simulable {
    // On gère le simulateur graphique du jeu
    private ConwayEvent simu;
    private ConwayEvent origine;
    private GUISimulator window;
    private EventManager manager;

    public ConwaySimulatorEvent(HashMap<Point, Integer> points,
     GUISimulator window) {
        // On crée conway du jeu de conway
        manager = new EventManager();
        this.simu = new ConwayEvent(points, manager);
