...
public class ImmigrationEvent extends Event {
    ...
    public ImmigrationEvent(int etats, int step, HashMap<Point, Integer> points, EventManager manager){
        super(0);
        nbrstates = etats;
        seuil = step;
        immigration = points;
    ...
    public ImmigrationEvent copie(){
        // On copie la structure pour pouvoir la garder en memoire
        ImmigrationEvent cop = new ImmigrationEvent(nbrstates, seuil,
