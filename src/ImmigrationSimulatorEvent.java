...
public class ImmigrationSimulatorEvent implements Simulable {
    // On gère le simulateur graphique du jeu
    private ImmigrationEvent simu;
    private ImmigrationEvent origine;
    private GUISimulator window;
    private EventManager manager;

    public ImmigrationSimulatorEvent(int etats,int step, HashMap<Point, Integer> points,
     GUISimulator window) {
        // On crée l'immigration du jeu de l'immigration
        manager = new EventManager();
        this.simu = new ImmigrationEvent(etats, step, points, manager);
